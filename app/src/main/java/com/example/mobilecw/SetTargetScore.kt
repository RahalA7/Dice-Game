...
class SetTargetScore : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textEdit = findViewById(R.id.inputScore)
        btn = findViewById(R.id.final_popup_btn2)

        btn.setOnClickListener {
            maxScore = textEdit.text.toString().toInt() // Convert to Int value
        ...
        if (savedInstanceState != null) {
            ...
            textEdit.setText(savedInstanceState.getString("editTextValue"))
        }
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putString("editTextValue", textEdit.text.toString())
    }
