...
class NewGameActivity : AppCompatActivity() {
    ...
    var playerAttempts : Int = 0 // Global var to store the number of rounds/attempts for user
    var compAttempts : Int = 0 // Global var to store the number of rounds/attempts for computer
    ...
    private fun diceRoller() {
        ...
        if (computerScore <= maxScore && !humanTurn) {
            compAttempts += 1
            computerPlay()
        }
        ...
        if (computerScore >= maxScore || playerScore >= maxScore) {
            ...
            if (compAttempts == playerAttempts) {
            ...
            } else if (compAttempts < playerAttempts) {
                compAttempts += 1
                computerPlay()
            } else if (playerAttempts < compAttempts) {
                playerAttempts += 1
                humanPlay()
            }
        }
